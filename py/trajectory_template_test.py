...
hip_traj_generator.set_max_hip_flexion_time(0.84*halfTotalTime/sample_time)       # in ms
hip_traj_generator.set_step_time(int(halfTotalTime/sample_time))	# in ms, integer. 5000 here.
...
knee_traj_generator.set_max_hip_flexion_time(0.84*halfTotalTime/sample_time)       # in ms
knee_traj_generator.set_step_time(int(halfTotalTime/sample_time))    # in ms, integer. 5000 here.
